...
const IconButton = ({ icon: Icon, onClick, variant = 'default', className = '', disabled = false }) => {
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`p-1.5 rounded transition-all duration-200 ${variantClasses[variant]} ${className} ${
...
const Button = ({ children, onClick, variant = 'primary', className = '', disabled = false }) => {
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm rounded transition-all duration-200 flex items-center gap-1.5 sm:gap-2 font-medium ${variantClasses[variant]} ${className} ${
        disabled ? 'opacity-50 cursor-not-allowed' : ''
      }`}
    >
      {children}
...
// ==================== STATS CARD ====================
const StatsCard = ({ title, value, subValue, icon: Icon, color, tooltip, onClick }) => {
  const colorMap = {
    green: 'bg-[#008751]',
    gold: 'bg-[#FFC107]',
  ...
  return (
    <Tooltip text={tooltip}>
      <div 
        onClick={onClick}
        className={`bg-white border border-[#E8E3DC] p-4 sm:p-5 ${onClick ? 'cursor-pointer hover:border-[#008751] transition-colors' : ''}`}
      >
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-medium text-[#5A5A5A] uppercase tracking-wider">{title}</p>
            <p className="mt-1 text-xl sm:text-2xl font-display font-bold text-[#1A1A1A] tracking-tight">{value}</p>
            {subValue && (
              <p className="text-xs text-[#5A5A5A] mt-0.5">{subValue}</p>
            )}
          </div>
          <div className={`w-10 h-10 ${iconColorMap[color]} rounded flex items-center justify-center flex-shrink-0 ml-3`}>
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-[#F7F5F2] w-full max-w-4xl max-h-[90vh] overflow-hidden transform transition-all duration-300">
          {/* Header */}
          <div className="border-b border-[#E8E3DC] p-6 bg-white">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-[#E8F5EF] border-2 border-[#008751] flex items-center justify-center text-2xl font-display font-bold text-[#008751]">
                  {getInitials(patient.name)}
                </div>
                <div>
                  <h2 className="text-xl font-display font-bold text-[#1A1A1A]">{patient.name}</h2>
                  <div className="flex flex-wrap items-center gap-3 mt-1 text-sm text-[#5A5A5A]">
                    <span className="flex items-center gap-1">
                      {getGenderIcon(patient.gender)}
                      {patient.gender || 'Not specified'}
                    </span>
              ...
              <button
                onClick={onClose}
                className="p-2 hover:bg-[#F0EDE8] rounded transition-colors"
              >
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              {patient.genotype && (
                <span className="inline-flex items-center px-2.5 py-0.5 text-xs font-medium border border-[#C8DDDB] bg-[#E8F5EF] text-[#0D6B6B]">
                  <BrainIcon className="w-3 h-3 mr-1" />
                  Genotype: {patient.genotype}
                </span>
              )}
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-[#E8E3DC] p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-[#1A1A1A] capitalize">{patient.gender || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-[#1A1A1A] capitalize">{patient.maritalStatus || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white border border-[#E8E3DC] p-4">
                <h3 className="text-sm font-display font-semibold text-[#1A1A1A] mb-3 flex items-center gap-2">
                  <HeartPulseIcon className="w-4 h-4 text-[#C8553D]" />
                  Medical Information
                </h3>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white border border-[#E8E3DC] p-4">
                <h3 className="text-sm font-display font-semibold text-[#1A1A1A] mb-3 flex items-center gap-2">
                  <ShieldIcon className="w-4 h-4 text-[#FFC107]" />
                  Emergency Contact
                </h3>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white border border-[#E8E3DC] p-4 md:col-span-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-[#1A1A1A]">{formatDate(patient.registration_date || patient.created_at)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[#5A5A5A]">Last Visit</span>
                    <span className="font-medium text-[#1A1A1A]">{formatDate(patient.lastVisit)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatsCard
            ...
            icon={Users}
            color="green"
            tooltip="Total patients under your care"
          ...
          <StatsCard
            ...
            icon={Stethoscope}
            color="teal"
            tooltip="Ward rounds scheduled for today"
          ...
          <StatsCard
            ...
            icon={FileText}
            color="warm"
            tooltip="Consultations awaiting your review"
        ...
        <div className="bg-white border border-[#E8E3DC] p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-display font-semibold text-[#1A1A1A]">Clinical Alerts</h2>
            <Button
              onClick={() => setAlerts(prev => prev.map(a => ({ ...a, read: true })))}
              variant="secondary"
              className="text-xs"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                {bulkUploading ? (
                  ...
                  <CheckCircle className="w-4 h-4 text-[#2D7D46]" />
                ) : bulkUploadResult?.status === 'failed' ? (
                  <AlertTriangle className="w-4 h-4 text-[#C8553D]" />
                ) : (
                  <Loader2 className="w-4 h-4 text-[#008751] animate-spin" />
                )}
                        ...
                        <div className="relative">
                          ...
                          {showStatusMenu === appointment.id && (
                            <div className="absolute right-0 mt-1 w-36 bg-white border border-[#E8E3DC] z-10 py-1">
                              <button
                                onClick={() => handleStatusChange(appointment.id, 'scheduled')}
                                className="w-full text-left px-3 py-1.5 text-xs hover:bg-[#F7F5F2] flex items-center gap-2"
                              >
