...
const PublicPageShell = ({
  ...
  badge = 'Powered by SmartCare HMS',
  brand = null,
}) => {
  const themeColor = brand?.theme_color || '#0B6E4F';
  const accentColor = brand?.accent_color || '#0A2540';
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(11,110,79,0.10),_transparent_35%),radial-gradient(circle_at_top_right,_rgba(59,130,246,0.12),_transparent_30%),linear-gradient(135deg,_#f8fbff_0%,_#f3f6fb_100%)] px-4 py-8 text-slate-800 sm:px-6 lg:px-8 lg:py-12">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <div className="relative overflow-hidden rounded-[32px] border border-slate-200/80 bg-white/90 p-6 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.35)] backdrop-blur sm:p-8 lg:p-10" style={{ borderColor: `${themeColor}22` }}>
          ...
          <div className="relative z-10 flex flex-col gap-6">
            <div className="flex flex-col gap-5 rounded-3xl border border-slate-100 bg-slate-50/80 p-5 sm:p-7 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em]" style={{ borderColor: `${themeColor}33`, backgroundColor: `${themeColor}12`, color: themeColor }}>
              ...
              {actionTo && (
                <Link
                  ...
                  style={{ borderColor: `${themeColor}33`, color: accentColor }}
                >
