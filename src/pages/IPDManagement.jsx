...
const IPDManagement = () => {
  ...
  return <main className="min-h-screen bg-[#F7F5F2] p-4 sm:p-6 lg:p-8"><div className="mx-auto max-w-7xl">
    ...
    {tab === 'vitals' && <div className="border border-slate-200 bg-white p-5"><h2 className="flex items-center gap-2 text-sm font-semibold"><Activity size={16} /> Existing vitals workflow</h2><p className="mt-2 text-sm text-slate-500">Use the selected inpatient context to record BP, pulse, temperature, SpO2, respiratory rate, and pain score through the Vital Signs module.</p><a href="/vital-signs" className="mt-4 inline-flex items-center gap-2 bg-[#1C2B27] px-4 py-2 text-xs font-semibold text-white"><HeartPulse size={14} /> Open vitals charting</a></div>}
  </div></main>;
};
